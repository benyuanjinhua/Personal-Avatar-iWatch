...
/// ESS-180：语音球（Voice Orb）——只表达四态，且每态有专属呼吸节奏。
///
...
struct VoiceOrbView: View {
    ...
    var body: some View {
        ZStack {
            Circle()
                ...
                .modifier(BreathingScale(hertz: breathHertz, amplitude: breathAmplitude))
            ...
            if case .listening = mode {
                ...
                Image(systemName: symbol)
                    ...
                    .modifier(BreathingScale(hertz: breathHertz, amplitude: breathAmplitude * 0.3))
            }
        }
    ...
    /// 呼吸频率（Hz）——白梦林规格里 idle=0.9 / listening=2 / thinking=1.3。
    private var breathHertz: Double {
        switch mode {
